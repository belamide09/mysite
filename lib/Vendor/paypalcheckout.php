...
public function __construct($config=""){
  ...
  //default settings
  $settings = array(
  'business' => 'richcode21-facilitator@gmail.com', //YCRFFUNDHHUZG        //paypal email address
  'currency' => 'JPY',                       //paypal currency
  'cursymbol'=> '&yen;',                   //currency symbol
  'location' => 'JP',                        //location code  (ex GB)
  'returnurl'=> 'https://nativecamp.net/user/payment',//where to go back when the transaction is done.
  'returntxt'=> 'Return to Native Camp',         //What is written on the return button in paypal
  'cancelurl'=> 'https://nativecamp.net/user/home',//Where to go if the user cancels.
  'no_shipping' => 1,
  'shipping' => 0,                           //Shipping Cost
  'custom'   => '',                           //Custom attribute
  'notify_url' => 'https://nativecamp.net/user/payment/callback'
  );
  ...
  $this->no_shipping = $settings['no_shipping'];
       ...
       if(!empty($this->items)){foreach($this->items as $item){
         $form.='
          <div id="item_'.$cpt.'" class="itemwrap">
            ...
            <input type="hidden" name="item_number_'.$cpt.'" value="'.$item['number'].'" />
